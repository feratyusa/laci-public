...
export default function ProposalPriceDetail({proposal, details}){
    const {data, setData, processing, put, delete: destroy, errors} = useForm({
        details: [...details]
    })    
    ...
    function handleAddDetailForm(){        
        const newDetail = [...data.details, {id: null, budget_type_id: null, price: 0}]
    ...
    function handleSubmit(){
        put(route('proposal.setPrices', [proposal.id]), {  
            preserveScroll: true,
            preserveState: false,          
            onSuccess: () => {
                localStorage.clear()
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <DeleteDialog variant="text" text={"Reset"} route={route('proposal.resetPrices', [proposal.id])} category={'proposal'} title={'Hapus Semua Anggaran Awal'} body={'Aksi ini tidak dapat dikembalikan'}/>
